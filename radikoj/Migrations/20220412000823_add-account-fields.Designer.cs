...
{
    [DbContext(typeof(RadikojDbContext))]
    [Migration("20220412000823_add-account-fields")]
    partial class addaccountfields
    {
            ...
            modelBuilder.Entity("GaspApp.Models.Account", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("LoginTokenExpiresAt")
                        .HasColumnType("timestamp with time zone");
